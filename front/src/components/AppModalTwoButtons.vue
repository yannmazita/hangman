<template>
    <dialog class="modal modal-bottom" :class="{ 'modal-open': props.showModal }">
        <div class="modal-box">
            <h3 class="font-bold text-lg"><slot name="headerText"></slot></h3>
...
const emit = defineEmits<{
    'clickEventA': [value: boolean],
    'clickEventB': [value: boolean],
}>();
</script>
